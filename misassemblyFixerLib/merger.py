...
def breakAcBkPtsTwoSided(contig, modifiedOutliners, folderName, mummerLink):
    ...
    for i in range(len(modifiedOutliners)-1):
        ...
        if startPt[2] != None and endPt[1] != None:
            insertItem = [startPt[2], endPt[1], startPt[4], endPt[3] ]
        elif startPt[2] == None :
            insertItem = [startPt[1], endPt[1], None, endPt[3] ]
        elif endPt[1] == None :
            insertItem = [startPt[2], endPt[2], startPt[4], None ]
